Shader "Aaron/Avatar/3_DepthAvatar" {
   Properties {
      ...
      _Alpha ("Alpha", Range(0, 21)) = 1
      _BumpDepth ("BumpDepth", Range(0.2,3.0)) = 1
   }
   SubShader {
...
//            localCoords.z = 1.0 - 0.5 * dot(localCoords, localCoords);
            ...
            float4 tex = tex2D(_BackTex, _BackTex_ST.xy * i.tex.xy + _BackTex_ST.zw);
