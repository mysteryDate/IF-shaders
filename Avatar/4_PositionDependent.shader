Shader "Aaron/Avatar/4_PositionDependent" {
   Properties {
      ...
      _FrontColor ("Front Color", Color) = (0.15, 0, 0.0, 0.0)
      ...
      _BumpDepth ("BumpDepth", Range(0.2,3.0)) = 0.7
      _IVSpotRadius ("Inner View Spot Raidus", Range(0, 1)) = 0.7
      _IVSpotPower ("Inner View Spot Power", Range(0, 100)) = 13.89
